...
function IconSocial (){
    return (
        <div className={styles.IconSocial}>
            ...
            <img className={styles.IconSocial_img} src={Instagram} alt='Instagram'  />
            </a>
            ...
            <img className={styles.IconSocial_img} src={Whatsapp} alt='Whatsapp' />
            </a>

            <a href='https://www.tiktok.com/@inkaro.tatt'>
            <img className={styles.IconSocial_img} src={TikTok} alt='TikTok' />
            </a>
        </div>      
    );
}
